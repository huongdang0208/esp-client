...
#define REMOTE_SERVICE_UUID        "A07498CA-AD5B-474E-940D-16F1FBE7E8CD"
#define REMOTE_NOTIFY_CHAR_UUID    "51FF12BB-3ED8-46E5-B4F9-D64E2FEC021B"
...
static void esp_gap_cb(esp_gap_ble_cb_event_t event, esp_ble_gap_cb_param_t *param)
{
    ...
    case ESP_GAP_BLE_SET_PKT_LENGTH_COMPLETE_EVT:
        printf("packet length updated: rx = %d, tx = %d, status = %d", param->pkt_data_lenth_cmpl.params.rx_len, param->pkt_data_lenth_cmpl.params.tx_len, param->pkt_data_lenth_cmpl.status);
        break;
    default:
        break;
    }
